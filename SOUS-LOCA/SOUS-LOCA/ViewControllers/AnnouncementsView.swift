    ...
    var body: some View {
        VStack {
            ...
            GeometryReader { geometry in
                HStack(spacing: geometry.size.width * 0.2) { // Ajustement dynamique de l'espacement (20% de la largeur de l'écran)
                    ...
                    ForEach(announcements.indices, id: \.self) { index in
                        ...
                        VStack {
                            ...
                            .frame(width: 280, height: 150) // La taille de chaque carte
                            .background(
                ...
                .padding(.horizontal, (geometry.size.width - 280) / 2) // Centrer la carte dans la vue
                .offset(x: CGFloat(currentIndex) * -(geometry.size.width * 0.2 + 280)) // Décalage ajusté pour l'espacement
